...
| <a name="module_eks"></a> [eks](#module\_eks) | github.com/aws-ia/terraform-aws-eks-blueprints//modules/kubernetes-addons/helm-addon | v4.12.2 |
...
| Name | Type |
|------|------|
| [aws_iam_policy.ack_eks_policy](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_policy) | resource |
...
| [aws_iam_policy_document.ack_eks_policy_document](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/iam_policy_document) | data source |
...
| <a name="input_eks_helm_config"></a> [eks\_helm\_config](#input\_eks\_helm\_config) | ACK eks Helm Chart config | `any` | `{}` | no |
