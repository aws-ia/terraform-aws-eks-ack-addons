...
| <a name="module_wafv2"></a> [wafv2](#module\_wafv2)                                                         | aws-ia/eks-blueprints-addon/aws | 1.1.1 |
...
| <a name="input_enable_wafv2"></a> [enable\_wafv2](#input\_enable\_wafv2)                                         | Enable ACK WAFv2 add-on                                                               | `bool` | `false` | no |
...
| <a name="input_wafv2"></a> [wafv2](#input\_wafv2)                                                                     | ACK WAFv2 Helm Chart config                                                           | `any` | `{}` | no |
